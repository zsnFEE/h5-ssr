<template>
  <div class="redeemCodeLink" ref="redeemCodeLink">
    <img
      :src="
        windowWidth < 768
          ? require('../../assets/img/bg_coupon.png')
          : require('../../assets/img/bg_coupon_pad.png')
      "
      alt=""
      class="bgImg"
    />
    ...
    <div class="couponStyle">
      <div class="couponBox" v-show="show">
        <div
          class="couponBoxLeft"
          v-if="
      ...
      <button class="buttonBox" @click="receiveCoupon">
...
.redeemCodeLink {
  ...
  .buttonBox {
    ...
    font-weight: bold;
    color: #ffffff;
    background: linear-gradient(180deg, #fb6866 1%, #f12f26 100%);
    // line-height: 73px;
    .shadow {
      top: 6px;
      position: absolute;
